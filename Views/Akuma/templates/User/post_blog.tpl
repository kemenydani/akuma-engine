        ...
        <div class="widget-inner">
            ...
            <div class="widget-body">
                ...
                <div style="">
                    ...
                    <form action="{$base}user/postblog/" method="POST">
                    <div class="field">
                            <label>Blog post title:</label>
                            <input type="text" {if $errors.blog_title}style="border: 1px solid #802420;"{/if} value="{$data.blog_title}" name="blog_title" placeholder="Title">
                    ...
                    <div class="field">
                            ...
                            <input type="text" {if $errors.blog_image}style="border: 1px solid #802420;"{/if} value="{$data.blog_image}" name="blog_image" placeholder="Blog image">
                    ...
                    <div class="field">
                        ...
                        <textarea name="blog_quote" style="width: 99%; height: 60px;"></textarea>
                    </div><br>
                    <div class="field">
                            <label>BLOG CONTENT:</label>
                    <textarea id="blog_content" name="blog_content" style="width: 99%; height: 200px;"></textarea>
                    </div>
                    ...
                    {else}
                        <div style="font-size: 12px; background-color: #22B573; padding: 5px; border-radius: 4px;">The post has been succesfully created, but you have to wait for the administrators to activate your post.</div><br>
                    {/if}
                </div>
