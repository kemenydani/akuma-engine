...
<div class="panel">
    ...
    {else}
        <div class="container no-commenting">Commenting is only available for registered users. Please log in or register <a href="{$base}user/register/">here</a>.</div>
    {/if}
    <center class="box comments">
