...
class Croppic {
    ...
    public static $image_upload_path = "Uploads/files/MODULES/Users/";
	...
	global $user, $db;
	    ...
	    if (!file_exists(self::$image_upload_path . $user['user_id'] . '/')) {
		mkdir(self::$image_upload_path . $user['user_id'] . '/', 0777, true);
	    }
	
	    $imagePath = self::$image_upload_path . $user['user_id'] . '/';
	    ...
	    if (in_array($extension, $allowedExts)){
		  ...
		  $filename = $_FILES["img"]["tmp_name"];
		      ...
		      $db->query("UPDATE xyz_users SET avatar = '".$imagePath.$_FILES["img"]["name"]."' WHERE user_id = ".$user['user_id']."");
